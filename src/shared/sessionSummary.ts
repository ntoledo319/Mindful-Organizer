...
<head>
  <meta charset="utf-8">
  <title>Paulatim session summary</title>
  <style>
...
<body>
  <header>
    <p class="eyebrow">Paulatim · ${days}-day reflection</p>
  ...
  <footer>
    Generated entirely on this device. Paulatim does not upload this report or the data behind it. Sharing the saved PDF is always the user's choice.
  </footer>
</body>
</html>`;
}
