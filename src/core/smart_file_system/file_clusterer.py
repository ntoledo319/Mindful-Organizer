        ...
        try:
            ...
            if len(embeddings_array) > 10:
                try:
                    ...
                    reducer = umap.UMAP(
                        n_components=5, metric="cosine", n_neighbors=15, min_dist=0.1
                    )
            ...
            # Generate labels
            cluster_labels = self._generate_cluster_labels(reduced_embeddings, clusters, file_paths)
