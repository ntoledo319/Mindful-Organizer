...
class CopingEngine:
    ...
    def _build_strategy_library(self) -> list[CopingStrategy]:
        ...
        strategies = [
            ...
            CopingStrategy(
                ...
                "Do one small pleasant activity",
                [
                    "Choose a simple activity you usually enjoy",
                    "Set a timer for 10 minutes",
                    "Begin the activity without judging",
                    "Notice any shifts in mood",
                ],
                10,
                EnergyLevel.LOW,
                ["depression", "anxiety"],
            ...
            CopingStrategy(
                ...
                [
                    "Write down 3 things to do today",
                    "Start with the easiest one",
                    "Check each off as completed",
                    "Celebrate completing the list",
                ],
                15,
                EnergyLevel.LOW,
                ["depression", "adhd"],
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Follow through and notice how you feel",
                ],
                10,
                EnergyLevel.LOW,
                ["depression"],
            ...
            CopingStrategy(
                "beh_04",
                "Opposite Action",
                "Act opposite to the emotion urge",
                [
                    "Identify the emotion you're feeling",
                    "Notice what the emotion urges you to do",
            ...
            CopingStrategy(
                ...
                [
                    "Identify one task that feels overwhelming",
                    "Break it into steps that take under 5 minutes",
                    "Do just the first step",
                    "Reward yourself and decide if you continue",
                ],
                5,
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Notice 3 new things in the new space",
            ...
            CopingStrategy(
                "beh_07",
                "Mastery Activity",
                "Do something that gives a sense of accomplishment",
                [
                    "Choose a task you know you can complete",
                    "Work on it for 10-15 minutes",
                    "Acknowledge what you accomplished",
                    "Rate your sense of mastery 1-10",
                ],
                15,
                EnergyLevel.MODERATE,
                ["depression"],
                CopingCategory.BEHAVIORAL,
                "CBT mastery and pleasure",
            ),
            # COGNITIVE
            CopingStrategy(
                "cog_01",
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Visualize the thought as clouds passing",
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "List 3 different ways to view it",
                    "Which perspective is most helpful?",
                    "Adopt that perspective intentionally",
                ],
                10,
                EnergyLevel.MODERATE,
                ["anxiety", "depression"],
            ...
            CopingStrategy(
                ...
                [
                    "Set a 15-minute 'worry time' later today",
                    "Write worried thoughts on a list to address then",
                    "When worry time comes, review the list",
                    "Most worries will feel less urgent",
                ],
                5,
                EnergyLevel.LOW,
                ["anxiety", "ocd"],
                CopingCategory.COGNITIVE,
                "CBT worry management",
            ),
            CopingStrategy(
                "cog_05",
                ...
                [
                    ...
                    "Remember suffering is part of being human",
                    "Place hand on heart",
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Identify one small action aligned with each",
                    "Choose one action to do today",
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Really feel the gratitude for each one",
                ...
                ["depression"],
                CopingCategory.COGNITIVE,
                "Positive psychology gratitude research",
            ),
            # SENSORY
            CopingStrategy(
                "sen_01",
            ...
            CopingStrategy(
                ...
                "Use cold water to activate the dive reflex",
                [
                    "Get a bowl of cold water or ice",
                    "Splash cold water on your face",
                    "Or hold ice cubes in your hands",
                    "Notice the physical sensation and breathing change",
                ],
                3,
                EnergyLevel.VERY_LOW,
                ["anxiety", "ptsd"],
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Move up: calves, thighs, abdomen, arms, shoulders, face",
            ...
            CopingStrategy(
                "sen_05",
                "Scent Grounding",
                "Use pleasant scents to ground and calm",
                [
                    "Choose a calming scent (lavender, peppermint, citrus)",
                ...
                ["anxiety", "ptsd"],
                CopingCategory.SENSORY,
                "Aromatherapy and grounding",
            ),
            CopingStrategy(
                "sen_06",
                "Texture Grounding",
                "Focus on physical textures",
                [
                    "Find an object with interesting texture",
                    "Run your fingers over it slowly",
                    "Describe the texture to yourself in detail",
            ...
            CopingStrategy(
                "sen_07",
                "Weighted Comfort",
                "Use weighted blanket or heavy pressure",
                [
                    "Get a weighted blanket or heavy covers",
                    "Lie down and cover yourself",
                    "Focus on the pressure sensation",
                    "Breathe slowly and let yourself relax",
                ],
                15,
                EnergyLevel.VERY_LOW,
                ["anxiety", "ptsd", "adhd"],
                CopingCategory.SENSORY,
                "Deep pressure therapy research",
            ),
            # SOCIAL
            CopingStrategy(
                "soc_01",
            ...
            CopingStrategy(
                ...
                [
                    "Think of a small kind gesture",
                    "It can be as simple as a compliment",
                    "Follow through with the gesture",
                    "Notice how helping others feels",
                ],
                10,
                EnergyLevel.LOW,
                ["depression"],
                CopingCategory.SOCIAL,
                "Positive psychology and altruism",
            ),
            CopingStrategy(
                "soc_03",
                "Body Doubling",
                ...
                [
                    "Ask someone to sit with you while you work",
                    "Or go to a coffee shop or library",
                    "Their presence helps maintain focus",
                    "You don't need to interact - just be near",
                ],
                30,
                EnergyLevel.LOW,
                ["adhd"],
                CopingCategory.SOCIAL,
                "ADHD body doubling strategy",
            ),
            CopingStrategy(
                "soc_04",
                "Validate Someone",
                ...
                [
                    "Listen to someone share their experience",
                    "Acknowledge their feelings without fixing",
                    "Say 'That makes sense' or 'That sounds hard'",
                    "Notice the connection that builds",
                ],
                10,
                EnergyLevel.MODERATE,
                ["anxiety"],
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Gently stretch to each side",
                    "Roll your shoulders forward and back",
                    "Touch your toes if comfortable",
                ],
                5,
                EnergyLevel.LOW,
                ["depression", "anxiety", "adhd"],
                CopingCategory.PHYSICAL,
                "Movement and mood research",
            ),
            CopingStrategy(
                "phy_03",
                "Box Breathing",
                "4-count breathing pattern",
                [
                ...
                ["anxiety", "ptsd", "ocd"],
                CopingCategory.PHYSICAL,
                "Breathing exercises research",
                True,
            ),
            CopingStrategy(
                "phy_04",
                "Intense Exercise",
                "Brief high-intensity movement",
                [
                ...
                CopingCategory.PHYSICAL,
                "TIPP skills intense exercise (DBT)",
            ),
            CopingStrategy(
                "phy_05",
                "Yoga Pose",
                "Hold a calming yoga pose",
                [
                    "Try child's pose: kneel, fold forward, arms extended",
                    "Or legs up the wall: lie back, legs resting on wall",
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Let the movement change your energy",
                ],
                5,
                EnergyLevel.MODERATE,
                ["depression", "adhd"],
            ...
            CopingStrategy(
                ...
                [
                    "Apply lotion or oil to your hands",
                    "Press thumb into palm and make circles",
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "When done, you can keep or discard it",
                ],
                10,
                EnergyLevel.LOW,
                ["depression", "anxiety", "ptsd"],
                CopingCategory.CREATIVE,
                "Expressive writing research",
            ),
            CopingStrategy(
                "cre_02",
                "Doodle or Color",
                "Draw or color without pressure",
                [
                    "Get paper and pens/pencils/crayons",
                    "Draw or color whatever feels right",
            ...
            CopingStrategy(
                ...
                [
                    "Choose an instrument or just your voice",
                    "Play or sing whatever comes to mind",
                    "Focus on the sounds and vibrations",
                    "Let yourself express what you feel",
                ],
                15,
                EnergyLevel.MODERATE,
                ["depression", "anxiety"],
            ...
            CopingStrategy(
                ...
                5,
                EnergyLevel.VERY_LOW,
                ["anxiety", "ptsd", "ocd", "depression", "adhd"],
                CopingCategory.SPIRITUAL,
            ...
            CopingStrategy(
                "spi_02",
                "Body Scan",
                "Slowly scan attention through your body",
                [
                    "Lie down or sit comfortably",
                    "Start attention at the top of your head",
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Repeat: 'May I be happy, may I be safe'",
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Focus on natural elements: trees, sky, wind",
                    "Touch a plant, stone, or the earth",
                    "Breathe and feel your connection to nature",
                ],
                10,
                EnergyLevel.LOW,
            ...
            CopingStrategy(
                ...
                [
                    ...
                    "Imagine a place where you feel totally safe",
    ...
    def get_recommendations(
        ...
        for strategy in self._strategies:
            ...
            score = self._score_strategy(
                strategy, mood, energy_level, condition_names, crisis_level
            )
    ...
    def get_strategy_stats(self) -> dict:
        ...
        return {
            ...
            "most_helpful": [
                {"strategy_id": sid, "avg_rating": round(avg, 1)} for sid, avg in most_helpful
            ],
        }
