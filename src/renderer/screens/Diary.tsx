              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mt-2">
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="font-medium text-semantic-error">{c.urgesSelfHarm ?? '-'}/5</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="text-xs text-text-muted dark:text-night-muted/80">Urge: Quit Therapy</span>
                    <span className="font-medium text-semantic-error">{c.urgesQuitTherapy ?? '-'}/5</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="text-xs text-text-muted dark:text-night-muted/80">Emotion: Sadness</span>
                    <span className="font-medium text-semantic-warning">{c.emotionsSadness ?? '-'}/5</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="text-xs text-text-muted dark:text-night-muted/80">Emotion: Fear</span>
                    <span className="font-medium text-semantic-warning">{c.emotionsFear ?? '-'}/5</span>
                  </div>
                </div>
