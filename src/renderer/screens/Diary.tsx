    ...
    <Modal open={open} onClose={onClose} title="Log Diary Card">
      <div className="space-y-6 max-h-[70vh] overflow-y-auto px-1 pt-2">
        ...
        <div className="space-y-2">
          ...
          >
            <p>
              Hearth records this rating locally; it does not monitor it, contact anyone, or detect an emergency.
        ...
        {createMutation.isError && <InlineError>Hearth could not save this card. Review the fields and try again.</InlineError>}
