...
export function Tasks() {
  ...
  const smartDecompose = async (t: Task) => {
    ...
    if (confirm(`Smart Decompose will break "${t.title}" into:\n- ${subtasks.join('\n- ')}\n\nProceed?`)) {
      await decomposeMutation.mutateAsync({ task: t, titles: subtasks });
    }
  };
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex gap-2 border-b border-base-border dark:border-night-border pb-4" role="tablist">
        <button
          role="tab"
