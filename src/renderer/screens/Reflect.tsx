  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      <div className="surface-card space-y-6 p-7">
        ...
        {saveMutation.isError && <InlineError>Paulatim could not save this check-in. Try again.</InlineError>}
      </div>
      <RecentList
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      <div className="surface-card space-y-5 p-7">
        ...
        {saveMutation.isError && <InlineError>Paulatim could not save this sleep log. Try again.</InlineError>}
      </div>
      <RecentList
        title="Recent nights"
        empty="Log a night and Paulatim starts reading your rhythm."
        items={recent.map((s) => ({
          id: s.id,
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      <div className="surface-card space-y-4 p-7 relative">
        ...
        {saveMutation.isError && <InlineError>Paulatim could not save this entry. Try again.</InlineError>}
      </div>
