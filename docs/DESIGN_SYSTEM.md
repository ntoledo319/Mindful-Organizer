...
Hearth is the "warm corner of your computer." The UI must target WCAG 2.2 AA,
...
- `text-text-muted`: Accessible muted text. Never so light that it fails the
  applicable WCAG AA contrast ratio.
