...
- Microsoft processes the purchase and any eligible refund under its
  then-current Store terms and applicable law;
- the developer does not promise that a refund is available for a particular
  purchase and will not ask for payment credentials through GitHub;
- a customer may report a reproducible package or product problem through the
  verified support channel, but support does not replace Microsoft's refund
  process.

Microsoft's current customer refund instructions are available at:
<https://support.microsoft.com/en-us/account-billing/returning-items-you-bought-from-microsoft-for-exchange-or-refund-81629012-aa4f-f48b-2394-8596f415072b>.
