...
*Formerly Mindful Organizer. Document version: 1.0 | May 2026*
...
Hearth is a desktop-native **psychological operating system** — the first desktop application that builds a persistent psychological profile and actively reconfigures the computing environment based on real-time psychological state. Unlike traditional productivity tools that ignore the user's mental state, or wellness apps that stop at logging, Hearth closes the loop: it *measures*, *interprets*, and *acts*.
...
**For the market:**
- **No direct competitor** exists at the desktop OS-intervention layer. Headspace/Calm are content libraries. RescueTime/Qustodio are surveillance/restriction tools. Notion/Todoist are passive task lists. Hearth is an *active, state-aware automation layer*.
...
| | ✅ Medication tracking | ✅ | ✅ |
| | ✅ 2 condition-aware themes | ✅ All 8 themes | ✅ All 8 themes |
...
| **Hearth Pro** | **$8/mo** | *Positioned between pure blockers and full wellness suites* |
| **Hearth Premium** | **$15/mo** | *Priced at parity with RescueTime + Headspace combined, but with OS-level integration neither offers* |
...
\* *Time cost imputed; no direct ad spend.*
...
- *First magic moment:* Manually trigger one rule (e.g., "Focus Mode") and watch Hearth close a distraction app. This demonstrates value immediately.
...
*Document maintained by Product Strategy. Updated quarterly against actuals.*
