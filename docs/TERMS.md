...
Hearth is personal organization and wellness software. Its primary function is
to help a user estimate task energy costs and plan against a daily energy budget
the user chooses from 4 to 24. Hearth does not infer or change that capacity
...
Hearth is not a medical device, healthcare provider, emergency service,
...
Hearth is open. At rest, Hearth uses authenticated AES-256-GCM snapshots and a
...
[privacy policy](PRIVACY.md). Do not use Hearth for information you are not
