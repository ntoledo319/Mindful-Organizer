...
| Ref | SHA | State | Notes |
|---|---|---|---|
| `origin/main` | evidence-only successor to `c8ec3a3d84065fb95b3a3e16154c6a90126ba716` (tree `3e092dc7b43583013ed293a62b0b31e9a3debc64`) | synchronized release-closeout evidence | Quality 34458468235 passed on exact `c8ec3a3`; re-derive the mutable successor SHA. No Windows run occurred and PAULATIM-001 bytes are unchanged. |
...
| local `main` (checked out) | evidence-only successor to `c8ec3a3d84065fb95b3a3e16154c6a90126ba716` (tree `3e092dc7b43583013ed293a62b0b31e9a3debc64`) | synchronized with origin after the evidence close; only enumerated pre-existing `.gitignore`/`.claude` paths remain dirty | Candidate source `f2d2a417` and certified bytes are unchanged; closeout work does not need a Windows package. |
...
| HIST-20260910-003 | 2026-09-10 | REPO-01 | documentation-consolidated | `c8ec3a3d84065fb95b3a3e16154c6a90126ba716` (tree `3e092dc7b43583013ed293a62b0b31e9a3debc64`) | remote + CI | Published the exact Quality result and refreshed repository history for the release-closeout commit. Quality 34458468235 passed; only Quality ran; no package, Partner Center field, Store copy, user-owned dirt, or stash changed. | verified | VER-20260910-004 |
...
static landing remains undeployed. Migrations: no discrete migration ledger exists — persistence uses
...
| G2 — candidate CI | **Resolved 2026-08-28:** PAULATIM-001 exact source `f2d2a417` has green Quality/Windows CI, independent package/screenshot hashes, and a staged kit | VER-20260828-003 |
| G3 — Partner Center | **Resolved 2026-08-31:** exact PAULATIM-001 certified and published; public $14.99 purchase path observed | Preserve the exact evidence; complete residual HQ-03 without implying it preceded publication |
...
Per-repo commit index is refreshed through REPO-01 `c8ec3a3`; later evidence-only
