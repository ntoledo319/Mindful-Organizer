...
local target used in this cycle were inside that root. Dependencies, artifacts,
screenshots, caches, evidence, and preserved capabilities remain inside the
jail. No outside local path was read or written. Remote GitHub and Partner
Center work was allowed by section 1.6. No autonomous human contact occurred.
...
- **Falsifier:** no zero-upfront seller path, marketplace/category rejection, or
  fewer than two purchases after 100 live page views.
