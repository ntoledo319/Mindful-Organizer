...
| Next recommended action | Owner, in order: **(1) recheck USPTO serial 97524800 on tmsearch.uspto.gov — 1 minute, gates everything downstream (R8)**; (2) start HQ-02 payout, longest latency; (3) HQ-01 IARC. Swap kit is pre-staged. HQ-03 is post-certification and no longer treated as a submission blocker | 2026-08-07 | section 11; `revenue/NAME-RISK-2026-08-07.md` |
...
| **R8 — "Hearth" name collision (new 2026-08-07, HIGHEST OPEN RISK)** | **high** | money attached to a contested name; rename after launch costs the listing | Hearth Display, Inc. (funded, Brooklyn) markets under "Hearth" for family organization/productivity software; USPTO 97524800 + WIPO 1716122 cover IC 009/042 software for household management, calendaring, routines, task delegation. Status stale — **owner must recheck serial 97524800 on tmsearch.uspto.gov (1 min) before HQ-04.** Full analysis + measured rename cost: `revenue/NAME-RISK-2026-08-07.md` | owner (decision), agent (rename sweep if chosen) |
